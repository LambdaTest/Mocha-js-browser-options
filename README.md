# Run Mocha Browser Options Tests on TestMu AI (Formerly LambdaTest)
...
Run Mocha Browser Options Tests on TestMu AI (Formerly TestMu AI (Formerly LambdaTest)) to ensure quicker developer feedback and faster go to market.

- [Sign up on TestMu AI](https://www.testmuai.com/register/) (Formerly TestMu AI (Formerly LambdaTest)).
- Follow the [TestMu AI Documentation](https://www.testmuai.com/support/docs/) for the full setup walkthrough.

If you want to set browser specific options for an automation test in Mocha-js on TestMu AI (Formerly TestMu AI (Formerly LambdaTest)), you can use the following steps. You can refer to sample test repo [here](https://github.com/LambdaTest/mocha-selenium-sample).
