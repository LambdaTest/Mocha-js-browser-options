# Run Mocha Tests With Custom Browser Options on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run Mocha Tests With Custom Browser Options across real browsers and operating systems.
